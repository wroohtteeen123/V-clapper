...
struct MainBoard: View {
    ...
    var dateFormatter: DateFormatter {
        ...
        fmtr.dateFormat = "yyyy-MM-dd ZZZZZ HH:mm:ss:SS"
...
//            }
            ...
            Text(timeNow).font(.largeTitle).fontWeight(.black).multilineTextAlignment(.leading).lineLimit(/*@START_MENU_TOKEN@*/3/*@END_MENU_TOKEN@*/).frame(width: /*@START_MENU_TOKEN@*/700.0/*@END_MENU_TOKEN@*/, height: /*@START_MENU_TOKEN@*/100.0/*@END_MENU_TOKEN@*/).onReceive(timer) {
